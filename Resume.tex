...
\textbf{Text Retrieval using Community Detection Techniques on a Word Association Graph Network} \\
\emph{A novel information retrieval technique that leverages community detection on a word association graph network generated from a news corpus. Iorking on it as my M.Sc. thesis.} \\
\vspace{0.04in}
...
\vspace{0.04in}
\textbf{Machine Learning-Based Prediction of Rice Leaf Nutrient Contents Across Growth Stages Using UAV Data} (Review in process in Smart Agricultural Technology) \\
...
\resumeCertificationHeading
{\textbf{\href{https://www.coursera.org/account/accomplishments/certificate/PQR86HHFEC46}{\emph{\color{NavyBlue}Introduction to Applied Machine Learning}}}}{Alberta Machine Intelligence Institute, Coursera, July 2020}
\vspace{-22pt}
\resumeCertificationHeading
