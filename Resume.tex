...
\textbf{Text Retrieval using Community Detection Techniques on a Word Association Graph Network} (M.Sc. Thesis 2024)\\
\emph{A novel information retrieval technique that leverages community detection on word association graph network using low resource machines. Also, experimenting hybrid approaches for ranking.} \\
\vspace{0.04in}
