...
\definecolor{Mycolor}{HTML}{282929}
\color{Mycolor}
...
\emph{Fine-tuned pre-trained multilingual Whisper LargeV2 with Low-Rank Adaptation
 Parameter Efficient Fine-Tuning Technique on a low specification computer and
 compared the performance with other transformer-based models like wav2vec2 and
 conformer.} \\
\vspace{0.04in}
...
\resumeSubheading
{Data Scientist}{November 2024 -- Present}
{AI DocBuilder, Toronto, Ontario, Canada (Remote)}{}\\
% \resumeSubHeadingListStart
% \vspace{0.1in}
% \vspace{-.1in}
\begin{itemize}[leftmargin=0.2in]
    \item Developing a lightweight OCR engine optimized for minimal computational resource usage while maintaining high accuracy and make it ready for production.
...
\resumeCertificationHeading
{\textbf{\href{https://www.coursera.org/account/accomplishments/specialization/certificate/S38DMAJSXH5A}{\emph{\color{NavyBlue}Machine Learning Specialization}}}}{University of Washington, Coursera, June 2020}
\vspace{-22pt}

\resumeCertificationHeading
{\textbf{\href{https://raw.githubusercontent.com/monirulHaque/monirulHaque.github.io/refs/heads/main/pdfs/Robotics.jpg}{\emph{\color{NavyBlue}Basics of Robotics}}}}{Brac University, Residential Campus, December 2018}
%     \vspace{-22pt}
% \resumeCertificationHeading
...
\begin{itemize}[leftmargin=0.2in, label={}, parsep=-3pt]
  ...
  \item [\ding{109}]{Co-Supervised a thesis titled \textbf{Analyzing and Predicting Trends in Contemporary Social Discourse through Hashtag Campaigns} which the students successfully defended in \textbf{Summer 2024}}
        }
...
\begin{itemize}[leftmargin=0.2in, label={}, parsep=-2pt]
  ...
  \item [\ding{112}]{Received \textbf{Merit-based scholarship of 25\% tution fees} in Brac University}
...
% \vspace{-8pt}
% \resumeSubheading
% {GRE Score: 302}{November 2024}
% {Quantitive: 156, Verbal: 146, Analytical Writing: N/A}{}
\resumeSubHeadingListEnd
\vspace{-8pt}
%-----------References-----------
\section{REFERENCES}
